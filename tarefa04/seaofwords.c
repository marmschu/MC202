...
// Para armazenar a matriz de letrar, criei uma matriz lista_palavras; Para verificar se a célula que vou checar a
// continuidade de uma palavra, já foi utilizada nesta mesma palavra, criei uma matriz_visitados; Nessa matriz, toda
// vez que eu passar por uma célula e der paridade ccom a letra k da minha palavra, irei transformar a celula dela em 1;
